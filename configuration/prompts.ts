...
const PRODUCT_GUIDANCE = `Always look for opportunities to recommend relevant products with direct links when answering questions or providing information.`;
...
When appropriate, include relevant product recommendations with direct links.
Respond with the following tone: ${AI_TONE}
...
If relevant to the query, recommend specific products with direct links.
Respond with the following tone: ${AI_TONE}
Now respond to the user's message:
`;
}
...
export function HYDE_PROMPT(chat: Chat) {
  ...
  If the conversation is about products or shopping, include relevant product links and recommendations in your hypothetical responses.
